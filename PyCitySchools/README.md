...
645−675)𝑢𝑛𝑑𝑒𝑟𝑝𝑒𝑟𝑓𝑜𝑟𝑚𝑒𝑑𝑐𝑜𝑚𝑝𝑎𝑟𝑒𝑑𝑡𝑜𝑠𝑐ℎ𝑜𝑜𝑙𝑠𝑤𝑖𝑡ℎ𝑠𝑚𝑎𝑙𝑙𝑒𝑟𝑏𝑢𝑑𝑔𝑒𝑡𝑠(<
645−675)underperformedcomparedtoschoolswithsmallerbudgets(<
585 per student).
As a whole, smaller and medium sized schools dramatically out-performed large sized schools on passing math performances (89-91% passing vs 67%).
As a whole, charter schools out-performed the public district schools across all metrics. However, more analysis will be required to glean if the effect is due to school practices or the fact that charter schools tend to serve smaller student populations per school. 
Charter school has higher math and reading passing rate than district school.
There is not much difference among all these fifteen schools on reading score by grade. But there is some difference on math scores by grade among these schools. 
